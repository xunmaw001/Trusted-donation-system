    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">可信捐赠系统注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <!--
                            <el-form-item label="积分" class="input" v-if="tableName=='yonghu'">
                                <el-input v-model="ruleForm.newMoney" autocomplete="off" placeholder="积分"  />
                           </el-form-item>
                        -->
                        <!--
...
<style lang="scss" scoped>
	...
	.container {
		...
		background-image: url(/kexinjuanzengxitong/img/back-img-bg.jpg);
