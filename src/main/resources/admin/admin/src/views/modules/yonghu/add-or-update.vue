    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="积分" prop="newMoney">
                       <el-input v-model="ruleForm.newMoney"
                                 placeholder="积分" clearable  :readonly="ro.newMoney"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="积分" prop="newMoney">
                           <el-input v-model="ruleForm.newMoney"
