    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="积分" prop="shangpinOrderTruePrice">
                       <el-input v-model="ruleForm.shangpinOrderTruePrice"
                                 placeholder="积分" clearable  :readonly="ro.shangpinOrderTruePrice"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="积分" prop="shangpinOrderTruePrice">
                           <el-input v-model="ruleForm.shangpinOrderTruePrice"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="快递公司" prop="shangpinOrderCourierName">
                       <el-input v-model="ruleForm.shangpinOrderCourierName"
                                 placeholder="快递公司" clearable  :readonly="ro.shangpinOrderCourierName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="快递公司" prop="shangpinOrderCourierName">
                           <el-input v-model="ruleForm.shangpinOrderCourierName"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="快递单号" prop="shangpinOrderCourierNumber">
                       <el-input v-model="ruleForm.shangpinOrderCourierNumber"
                                 placeholder="快递单号" clearable  :readonly="ro.shangpinOrderCourierNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="快递单号" prop="shangpinOrderCourierNumber">
                           <el-input v-model="ruleForm.shangpinOrderCourierNumber"
        ...
        data() {
            return {
                ...
                ro:{
                    ...
                    shangpinOrderCourierName: false,
                    shangpinOrderCourierNumber: false,
